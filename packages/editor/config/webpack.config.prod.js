...
module.exports = {
        ...
        use: [
          {
            options: {
              ...
              configFile: path.join(paths.appSrc, '../config/eslint/eslint.json'),
              emitWarning: true
            },
  ...
  plugins: [
    ...
    // TODO - Disabled this feature for now as it was causing some really strange caching
    // issues when deploying a new version of the tool
